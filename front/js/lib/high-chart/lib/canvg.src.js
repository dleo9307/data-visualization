 ...
 */
 (function ( global, factory ) {
	...
	if ( typeof define !== 'undefined' && define.amd ) {
		define('canvgModule', [ 'front/js/lib/high-chart/lib/rgbcolor', 'stackblur' ], factory );
	}

	// ...or as browserify
	else if ( typeof module !== 'undefined' && module.exports ) {
		module.exports = factory( require( 'front/js/lib/high-chart/lib/rgbcolor' ), require( 'stackblur' ) );
	}
